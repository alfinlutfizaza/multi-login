...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="<?php echo e(url('/')); ?>"><b>ITJEN</b>WIL2</a>
        </div>
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="<?php echo e(route('simpanregisterAuditor')); ?>" method="post">
...
<?php /**PATH C:\xamp\htdocs\multi-login\resources\views/Pengguna/registerAuditor.blade.php ENDPATH**/ ?>