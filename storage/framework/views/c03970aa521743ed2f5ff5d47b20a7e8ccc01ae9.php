                 ...
                 <li class="nav-item menu-open">
                     ...
                     <ul class="nav nav-treeview">
                         <?php if(@auth()->user()->level == 'admin'): ?>
                             <li class="nav-item">
                                 <a href="<?php echo e(route('halaman-satu')); ?>" class="nav-link active">
                         ...
                         <?php endif; ?>
                         <li class="nav-item">
                             <a href="<?php echo e(route('halaman-dua')); ?>" class="nav-link">
                                 <i class="far fa-circle nav-icon"></i>
                                 <p>Halaman 2</p>
                             </a>
                         </li>
...
<?php /**PATH C:\xamp\htdocs\multi-login\resources\views/Template/sidebar.blade.php ENDPATH**/ ?>